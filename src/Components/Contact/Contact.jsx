...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "bef3d727-20f2-4fb4-ae0c-99be368b6f2f");
  ...
  return (
    <div className='contact'>
        <div className="contact-col">
            ...
            <p>Feel free to react out through contach form or find our contact
        ...
        <div className="contact-col">
            <form onSubmit={onSubmit}>
                ...
                <input type="te1" name='phone' placeholder='Enter your mobile number' required/>
